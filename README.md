...
**Use of this repository, its code, or the accompanying curated EHR dataset, in any research, publication, product, or derivative work, requires citation of the paper below.** This applies to academic papers, technical reports, thesis, and any public or commercial use of the system or data.
